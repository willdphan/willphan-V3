	...
	return (
		<div className="flex flex-col lg:flex-row justify-center bg-[#080808] sm:items-center py-4 lg:px-30 2xl:px-40 sm:pt-0">
			<section className="container mx-auto max-h-screen flex flex-col items-center justify-center relative pb-20">
				<div className="h-screen flex flex-col lg:fixed pt-20 lg:pt-0 lg:top-[5em] px-8 xl:px-28 space-y-4 ">
					...
					<p className="text-md text-[#9B9B9B] leading-loose font-Sans">
						...
						Blockchain, learning LLMs, & exploring UX/UI design. I have a weakness for diet coke & dogs. An
						avid grass toucher.
					</p>
					<div>
						<Menu />
			...
			<section className="container mx-auto flex flex-col min-h-screen px-6 lg:px-10 xl:px-28 pt-16 py-24 items-center justify-center ">
				<Projects />
				<Crafts />
				<Learnings />
			</section>
