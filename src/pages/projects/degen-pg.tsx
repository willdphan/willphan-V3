...
const NftCard = ({ title, id, image, value, last }) => {
	...
	return (
		<section id="learnings" className="w-full px-1 flex hover:cursor hover:cursor-pointer">
			<p className="columns-1 my-2 w-full flex items-center justify-center">
				<p className="w-full max-w-[24em] sm:max-w-[30em] bg-white transform transition duration-300 sm:hover:scale-[1.01] sm:hover:bg-[#F8F8F8] text-[#9B9B9B]  mb-2 font-Mono uppercase text-lg py-5">
					<motion.p
						exit={{ opacity: 0 }}
						initial={{ opacity: 0 }}
						animate={{ opacity: 1 }}
					...
					>
						...
						<p className="flex flex-col">
							...
							<p className="hidden sm:block sm:inline-flex space-x-3 ">
...
const Home: FC = () => {
	return (
		<p className="flex flex-col items-center  bg-white w-full min-h-screen ">
			<Enter />
			<p className="max-h-[55vh] flex flex-col lg:flex-row pt-36 w-full justify-center ">
