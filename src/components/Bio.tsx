	...
	return (
		<div className="pt-20 lg:fixed min-h-screen lg:pt-14  space-y-4 px-3 lg:px-10  ">
			...
			<p className="text-sm text-[#9B9B9B] leading-loose font-Sans md:max-w-[50em] lg:max-w-[30em]">
				A blockchain developer dabbling in UX/UI design. I&apos;m always trying to push the boundaries of
				what&apos;s possible and finding new ways to make a difference through technology. I have a weakness for
				diet coke & dogs. An avid grass toucher.
			</p>
			<div>
				<Menu />
			</div>
